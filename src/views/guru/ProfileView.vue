                ...
                <div class="min-h-screen max-w-md md:max-w-2xl lg:max-w-4xl mx-auto flex flex-col relative pb-32">
                    ...
                    <div class="px-6 -mt-14 relative z-20">
                        <div
                            ...
                            <h2 class="text-xl font-black text-slate-800 tracking-tight">{{ guruName || 'Guru' }}</h2>
                            <p class="text-primary font-bold text-xs tracking-wide">NIP: {{ guruNip || '-' }}</p>
